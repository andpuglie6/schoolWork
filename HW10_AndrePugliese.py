...
def litCricFriend(wordList, text):
    ...
    newWordList = []
    for t in inList:
        newWordList.append(t.strip(string.punctuation))
    ...
    return specificWordCount/len(newWordList)
...
'''
Yes the results show that Poe uses the definite article more and indefinite article less than Neruda.
'''
